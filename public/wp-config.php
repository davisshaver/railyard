...
if ( isset( $_SERVER['SERVER_SOFTWARE'] ) && strpos ($_SERVER['SERVER_SOFTWARE'], 'Flywheel/' ) !== false ) {
...
$multisite = getenv( 'WP_ALLOW_MULTISITE' ) !== false ? true : false;
$multisite_installed = getenv( 'WP_MULTISITE_INSTALLED' ) !== false ? true : false;
if ( $multisite) {
